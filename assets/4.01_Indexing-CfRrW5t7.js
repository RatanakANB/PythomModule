...
- [[1.02_String]] — Text is indexed by character
- [[1.07_list]] — Lists are indexed by item
- [[4.02_Slicing]] — Grabbing more than one item at once
- [[3.04_Comparison]] — Used often with indexing (e.g. \`if list[0] == "Apple"\`)
`;export{e as default};