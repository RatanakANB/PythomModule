...
2. \`.title()\` → Capitalize first letter of each word → \`"John Smith"\` ([[String_Methods]])
3. The **dot** chains two methods: \`strip()\` runs first, then \`title()\` runs on the result
4. Original \`raw_name\` is **unchanged** — [[Mutability_vs_Immutability|immutable]]
...
- **Mutable vs Immutable behavior:** [[Mutability_vs_Immutability]]
...
- **All methods overview:** [[Methods_Insight]]
`;export{e as default};