...
3. \`phone = "012-345-6789"\` → Now phone holds a [[1.02_String]] value
...
- **Related types:** [[1.05_Bool]] (\`bool(None)\` → \`False\`), [[1.02_String]] (\`str(None)\` → \`"None"\`)
- **Operators:** [[3.06_Identity]] (\`is None\` is the correct way to check), [[3.03_Logical]] (None is falsy in logic)
- **Key concept:** None has **no methods** — it's the simplest type
- **Compare with:** [[1.03_Interger]] (0), [[1.02_String]] (""), [[1.07_list]] ([]) — these are "empty" but NOT None
`;export{e as default};