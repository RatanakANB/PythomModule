...
3. \`gpa = 3.85\` → Decimal numbers use [[float]]
4. \`is_enrolled = True\` → Checkboxes are like [[bool]] — either on or off
5. \`graduation_date = None\` → Empty fields are [[NoneType]] — nothing there yet
...
- **Data Types:** [[str]] · [[int]] · [[float]] · [[bool]] · [[NoneType]] · [[list]] · [[set]] · [[tuple]] · [[dict]]
- **Use methods on variables:** [[What_Are_Methods]]
- **Combine variables with:** [[Arithmetic]] · [[Comparison]] · [[Logical]]
