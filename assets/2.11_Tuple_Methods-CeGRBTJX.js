...
> 🏠 Parent: [[1.09_tuple]] · [[2.01_What_Are_Methods]]
> 📂 Section: Methods
...
This is a great example of [[2.02_Mutability_vs_Immutability]] in action — mutable types like [[1.07_list]] have 11 methods, while an immutable [[1.09_tuple]] only needs 2.
...
3. \`100 in scores\` → [[3.05_Membership]] operator checks if \`100\` exists → \`False\`
4. You **can't** change scores — that's why we use a tuple, not a [[1.07_list]]
