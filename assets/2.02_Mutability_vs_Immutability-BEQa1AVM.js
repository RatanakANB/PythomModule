...
3. [[1.2_str|Strings]] are like drawings. [[1.7_list|Lists]] are like LEGO!
...
|------|----------|------------------|---------|
| [[1.2_str]] | ❌ No | Return new value | \`text.upper()\` → new string |
| [[1.3_int]] | ❌ No | Return new value | \`n.bit_length()\` → new int |
| [[1.4_float]] | ❌ No | Return new value | \`f.is_integer()\` → bool |
| [[1.5_bool]] | ❌ No | Return new value | Inherited from int |
