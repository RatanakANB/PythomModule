...
|----------|-------------|-------------------|--------------|
| Case | Text formatting | [[1.02_String]] | Visual formatting |
| Check | Boolean logic | [[1.02_String]], [[1.08_set]], [[1.03_Interger]], [[1.04_Float]] | Validation |
| Search | Find data | [[1.02_String]], [[1.07_list]], [[1.09_tuple]] | Locate |
| Modify | Change data | [[1.02_String]] | Transform |
| Addition | Add elements | [[1.07_list]], [[1.08_set]], [[1.10_dictionary]] | Expand |
| Removal | Remove elements | [[1.07_list]], [[1.08_set]], [[1.10_dictionary]] | Reduce |
| Ordering | Sort/reorder | [[1.07_list]], [[1.02_String]] | Organize |
| Set Logic | Set operations | [[1.08_set]] | Relationship |
| Access | Retrieve values | [[1.10_dictionary]] | Extract |
...
|-----------|--------------|----------|------|
| [[1.02_String]] | 47 | ❌ No | Most methods of any type |
| [[1.03_Interger]] | 11 | ❌ No | Mostly conversion/bit ops |
| [[1.04_Float]] | 8 | ❌ No | Conversion and checking |
| [[1.05_Bool]] | 11 | ❌ No | Inherited from [[1.03_Interger]] |
| [[1.07_list]] | 11 | ✅ Yes | Most commonly used methods |
| [[1.08_set]] | 17 | ✅ Yes | Rich set logic operations |
| [[1.09_tuple]] | 2 | ❌ No | Only search — can't modify |
| [[1.10_dictionary]] | 11 | ✅ Yes | Key-value access & update |
...
3. **Transfer learning**: The "Search" category works similarly across [[1.02_String]], [[1.07_list]], and [[1.09_tuple]] (all have \`.index()\` and \`.count()\`)
...
- Only [[1.10_dictionary]] has dedicated access methods (\`get\`, \`keys\`, \`values\`, \`items\`)
