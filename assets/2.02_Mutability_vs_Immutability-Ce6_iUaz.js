...
- **Mutable** types (like [[1.07_list]], [[1.08_set]], [[1.10_dictionary]]) — you CAN change their contents after creation
- **Immutable** types (like [[1.02_String]], [[1.03_Interger]], [[1.04_Float]], [[1.05_Bool]], [[1.09_tuple]]) — you CANNOT change them; methods return a **new** value instead
...
3. [[1.02_String|Strings]] are like drawings. [[1.07_list|Lists]] are like LEGO!
...
|------|----------|------------------|---------|
| [[1.02_String]] | ❌ No | Return new value | \`text.upper()\` → new string |
| [[1.03_Interger]] | ❌ No | Return new value | \`n.bit_length()\` → new int |
| [[1.04_Float]] | ❌ No | Return new value | \`f.is_integer()\` → bool |
| [[1.05_Bool]] | ❌ No | Return new value | Inherited from int |
| [[1.09_tuple]] | ❌ No | Return new value | \`t.count(x)\` → new int |
| [[1.07_list]] | ✅ Yes | Modify in place | \`lst.sort()\` → changes lst |
| [[1.08_set]] | ✅ Yes | Modify in place | \`s.add(x)\` → changes s |
| [[1.10_dictionary]] | ✅ Yes | Modify in place | \`d.update({})\` → changes d |
...
- **See it in action:** [[2.05_String_Methods]] (immutable) · [[2.09_List_Methods]] (mutable) · [[2.10_Set_Methods]] (mutable) · [[2.12_Dict_Methods]] (mutable)
- **Data types:** [[1.02_String]] · [[1.03_Interger]] · [[1.04_Float]] · [[1.05_Bool]] · [[1.09_tuple]] · [[1.07_list]] · [[1.08_set]] · [[1.10_dictionary]]
`;export{e as default};