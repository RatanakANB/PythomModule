...
- **Similar types:** [[1.07_list]] (ordered, allows duplicates), [[1.09_tuple]] (ordered, immutable), [[1.10_dictionary]] (also uses \`{}\` but with key-value pairs)
- **Operators:** [[3.05_Membership]] (\`in\` is extremely fast for sets), [[3.04_Comparison]] (subset/superset checks)
