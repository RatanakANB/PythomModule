...
2. \`==\` [[Comparison|comparison operator]] checks if values match, returns a \`bool\`
3. \`and\` [[Logical|logical operator]] needs BOTH to be \`True\`
...
- **Parent:** [[Variables]]
- **Methods:** [[Bool_Methods]] (11 methods — inherited from [[int]])
- **Related types:** [[int]] (bool is a subclass of int), [[str]] (\`str(True)\` → \`"True"\`)
- **Operators:** [[Comparison]] (creates bools), [[Logical]] (\`and\`, \`or\`, \`not\`), [[Identity]] (\`is\`, \`is not\`)
- **Key concept:** [[Mutability_vs_Immutability]] — booleans are **immutable**
`;export{e as default};