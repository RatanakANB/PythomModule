...
> 🏠 Parent: [[1.5_bool]] · [[2.1_What_Are_Methods]]
> 📂 Section: Methods
> 🔑 Key concept: \`bool\` **inherits** from [[1.3_int]], so it shares all [[2.6_Int_Methods]]
...
You can call any [[2.6_Int_Methods]] on a boolean — though in practice, you rarely need to.
...
- **Data type:** [[1.5_bool]]
- **Inherits from:** [[1.3_int]] → [[2.6_Int_Methods]]
