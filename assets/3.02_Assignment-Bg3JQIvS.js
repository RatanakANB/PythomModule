...
**Assignment operators** store values in [[1.01_Variables|variables]]. The basic \`=\` assigns a value. The shorthand operators like \`+=\` combine an [[3.01_Arithmetic|arithmetic]] operation with assignment in one step.
...
- **Math operations:** [[3.01_Arithmetic]] (the operations behind \`+=\`, \`-=\`, etc.)
- **Compare values:** [[3.04_Comparison]]
- **Variables:** [[1.01_Variables]]
- **Also used with:** [[3.07_Bitwise]] (\`&=\`, \`|=\`, \`^=\`, \`<<=\`, \`>>=\`)
- **Parent:** [[00_Index]]
`;export{e as default};