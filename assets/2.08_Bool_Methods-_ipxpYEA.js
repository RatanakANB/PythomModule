...
> 🏠 Parent: [[1.5_bool]] · [[2.01_What_Are_Methods]]
> 📂 Section: Methods
> 🔑 Key concept: \`bool\` **inherits** from [[1.3_int]], so it shares all [[2.06_Int_Methods]]

---

## 📖 Beginner-Friendly Explanation

Booleans (\`True\` and \`False\`) are secretly a **subclass of integers** in Python. \`True\` is \`1\` and \`False\` is \`0\`. Because of this, booleans **inherit all 11 methods from [[1.3_int]]**.
...
- **Data type:** [[1.5_bool]]
- **Inherits from:** [[1.3_int]] → [[2.06_Int_Methods]]
- **Used by:** [[3.4_Comparison]] operators (return bools), [[3.3_Logical]] operators (\`and\`, \`or\`, \`not\`)
