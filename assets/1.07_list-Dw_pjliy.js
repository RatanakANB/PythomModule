...
- **Similar types:** [[1.09_tuple]] (like a list but can't change), [[1.08_set]] (like a list but no duplicates)
- **Related types:** [[1.02_String]] (also ordered and indexable), [[1.10_dictionary]] (stores key-value pairs instead)
- **indexing & Slicing:** [[4.01_Indexing]] (grab one item), [[4.02_Slicing]] (grab a section)
- **Operators:** [[3.01_Arithmetic]] (\`+\` joins lists), [[3.05_Membership]] (\`in\` checks if item exists), [[3.04_Comparison]] (compare lists)
