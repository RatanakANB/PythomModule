...
> 🏠 Parent: [[str]] · [[What_Are_Methods]]
> 📂 Section: Methods
> 🔑 Key concept: All string methods return **new** strings — strings are [[Mutability_vs_Immutability|immutable]]
...
> Return \`True\` or \`False\` ([[bool]]) — useful for **validation**.
...
**Join** a [[list]] of strings into one string, with the string as the separator.
...
- **Why methods return new values:** [[Mutability_vs_Immutability]]
- **Overview table:** [[Methods_Insight]]
- **Other method notes:** [[Int_Methods]] · [[Float_Methods]] · [[Bool_Methods]] · [[List_Methods]] · [[Set_Methods]] · [[Tuple_Methods]] · [[Dict_Methods]]
`;export{e as default};