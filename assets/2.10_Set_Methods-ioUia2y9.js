...
> 🏠 Parent: [[1.08_set]] · [[2.01_What_Are_Methods]]
> 📂 Section: Methods
...
Add **multiple items** from another iterable ([[1.07_list]], [[1.09_tuple]], another set, etc.).
...
> Return [[1.05_Bool]] — check relationships between sets.
...
- **Operators:** [[3.05_Membership]] (\`in\` is very fast for sets)
`;export{e as default};