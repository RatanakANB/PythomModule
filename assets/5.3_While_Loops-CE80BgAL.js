...
- A [[5.2_For_Loops|For Loop]] knows exactly how many times it will run (e.g., "for every item in this 5-item list").
...
- [[3.4_Comparison]] — Used to build the \`while\` condition (\`>\`, \`<\`, \`==\`)
- [[3.2_Assignment]] — Used inside the loop to update variables (\`+=\`, \`-=\`)
- [[1.5_bool]] — The loop condition is always checked as a boolean (True/False)
- [[5.1_If_Else]] — Often put inside while loops to make checks while it runs
`;export{e as default};