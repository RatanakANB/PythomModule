...
> 🏠 Parent: [[dict]] · [[What_Are_Methods]]
> 📂 Section: Methods
> 🔑 Key concept: Dicts are [[Mutability_vs_Immutability|mutable]] — methods can **add, change, and remove** key-value pairs
...
- **Other methods:** [[List_Methods]] · [[Set_Methods]] · [[String_Methods]]
- **Operators:** [[Membership]] (\`in\` checks for keys)
`;export{e as default};