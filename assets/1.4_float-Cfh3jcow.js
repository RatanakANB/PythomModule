...
A **float** is a **decimal number** — any number with a decimal point. Even \`3.0\` is a float, not an [[1.3_int]].
...
- **Related types:** [[1.3_int]] (whole number version), [[1.2_str]] (convert with \`str()\`), [[1.5_bool]] (\`0.0\` is False, anything else is True)
- **Operators:** [[3.1_Arithmetic]] (math with decimals), [[3.4_Comparison]] (compare values)
