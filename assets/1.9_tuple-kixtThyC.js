...
Sometimes a [[1.7_list]] isn't enough — you don't just want items in order, you want to **label** each item. Dictionaries let you store data with meaningful names instead of just positions.
...
3. \`profile["followers"] = 843\` → Change a value — dicts are **mutable** (see [[2.2_Mutability_vs_Immutability]])
...
- **Similar types:** [[1.7_list]] (ordered by index), [[1.8_set]] (also uses \`{}\` but no values)
- **Related types:** [[1.2_str]] (keys are often strings), [[1.3_int]] (values can be any type)
- **Operators:** [[3.5_Membership]] (\`in\` checks if a KEY exists), [[3.4_Comparison]] (compare dicts)
- **Key concept:** [[2.2_Mutability_vs_Immutability]] — dicts are **mutable**
`;export{e as default};