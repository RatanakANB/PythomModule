...
2. \`==\` [[3.04_Comparison|comparison operator]] checks if values match, returns a \`bool\`
3. \`and\` [[3.03_Logical|logical operator]] needs BOTH to be \`True\`
...
- **Methods:** [[2.08_Bool_Methods]] (11 methods — inherited from [[1.03_Interger]])
- **Related types:** [[1.03_Interger]] (bool is a subclass of int), [[1.02_String]] (\`str(True)\` → \`"True"\`)
- **Operators:** [[3.04_Comparison]] (creates bools), [[3.03_Logical]] (\`and\`, \`or\`, \`not\`), [[3.06_Identity]] (\`is\`, \`is not\`)
- **Key concept:** [[2.02_Mutability_vs_Immutability]] — booleans are **immutable**
`;export{e as default};