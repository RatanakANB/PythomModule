...
Python has 2 membership operators: \`in\` and \`not in\`. They check whether a value is found inside a sequence ([[str]], [[list]], [[tuple]], [[set]], [[dict]]).
...
- **Related:** [[Comparison]] (compares values), [[Identity]] (checks same object)
- **Set is fastest:** [[set]] is designed for membership testing
- **Dict checks keys:** [[dict]] — \`in\` only checks keys, not values
- **Parent:** [[00_Index]]
