...
> 🏠 Parent: [[int]] · [[What_Are_Methods]]
> 📂 Section: Methods
> 🔑 Key concept: Integers are [[Mutability_vs_Immutability|immutable]] — all methods return **new** values
...
For [[int]], this **always** returns \`True\` (more useful on [[float]]).
...
- **Data type:** [[int]]
- **Similar methods:** [[Float_Methods]] · [[Bool_Methods]] (inherits int methods)
- **Call syntax:** [[Method_Call_Syntax]]
- **Related operators:** [[Arithmetic]] · [[Bitwise]]
