...
> 🏠 Parent: [[list]] · [[What_Are_Methods]]
> 📂 Section: Methods
> 🔑 Key concept: Lists are [[Mutability_vs_Immutability|mutable]] — most methods **modify the list in place** and return \`None\`
...
- **Data type:** [[list]]
- **Mutable behavior:** [[Mutability_vs_Immutability]] — methods modify in place
- **Call syntax:** [[Method_Call_Syntax]]
- **Compare with:** [[Tuple_Methods]] (only 2 — tuples are immutable)
- **Overview:** [[Methods_Insight]]
- **Other methods:** [[String_Methods]] · [[Set_Methods]] · [[Dict_Methods]]
