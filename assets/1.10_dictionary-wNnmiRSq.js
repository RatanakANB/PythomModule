...
A **tuple** is like a [[1.7_list]] that **cannot be changed** after creation. It's ordered, allows duplicates, but is **locked** — you can't add, remove, or modify items.
...
2. \`home[0]\` → Access latitude by index (still works like a [[1.7_list]])
3. \`home[0] = 12.0\` → ❌ ERROR — tuples are **immutable** (see [[2.2_Mutability_vs_Immutability]])
