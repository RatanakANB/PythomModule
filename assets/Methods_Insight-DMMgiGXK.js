...
|----------|-------------|-------------------|--------------|
| Case | Text formatting | [[str]] | Visual formatting |
| Check | Boolean logic | [[str]], [[set]], [[int]], [[float]] | Validation |
| Search | Find data | [[str]], [[list]], [[tuple]] | Locate |
| Modify | Change data | [[str]] | Transform |
| Addition | Add elements | [[list]], [[set]], [[dict]] | Expand |
| Removal | Remove elements | [[list]], [[set]], [[dict]] | Reduce |
| Ordering | Sort/reorder | [[list]], [[str]] | Organize |
| Set Logic | Set operations | [[set]] | Relationship |
| Access | Retrieve values | [[dict]] | Extract |
...
|-----------|--------------|----------|------|
| [[str]] | 47 | ❌ No | Most methods of any type |
| [[int]] | 11 | ❌ No | Mostly conversion/bit ops |
| [[float]] | 8 | ❌ No | Conversion and checking |
| [[bool]] | 11 | ❌ No | Inherited from [[int]] |
| [[list]] | 11 | ✅ Yes | Most commonly used methods |
| [[set]] | 17 | ✅ Yes | Rich set logic operations |
| [[tuple]] | 2 | ❌ No | Only search — can't modify |
| [[dict]] | 11 | ✅ Yes | Key-value access & update |
...
3. **Transfer learning**: The "Search" category works similarly across [[str]], [[list]], and [[tuple]] (all have \`.index()\` and \`.count()\`)
...
- Only [[dict]] has dedicated access methods (\`get\`, \`keys\`, \`values\`, \`items\`)
...
- **All method references:**
  - [[String_Methods]] (47) · [[Int_Methods]] (11) · [[Float_Methods]] (8) · [[Bool_Methods]] (11)
  - [[List_Methods]] (11) · [[Set_Methods]] (17) · [[Tuple_Methods]] (2) · [[Dict_Methods]] (11)
`;export{e as default};