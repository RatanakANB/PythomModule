...
> 🏠 Parent: [[1.4_float]] · [[2.1_What_Are_Methods]]
> 📂 Section: Methods
> 🔑 Key concept: Floats are [[2.2_Mutability_vs_Immutability|immutable]] — all methods return **new** values

---

## 📖 Beginner-Friendly Explanation

Floats have **8 methods** — for converting between formats, checking properties, and working with the complex number system. They're simpler than [[2.5_String_Methods]] but important for understanding how Python handles decimal numbers.
...
- **Data type:** [[1.4_float]]
- **Similar methods:** [[2.6_Int_Methods]] · [[2.8_Bool_Methods]]
