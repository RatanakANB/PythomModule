...
Arithmetic operators perform mathematical operations on numbers ([[1.3_int]], [[1.4_float]]).
...
| -------- | -------------- | --------- | ---------- | --------------------------------- |
| \`+\`      | Addition       | \`5 + 3\`   | \`8\`        | Also joins [[1.2_str]] and [[1.7_list]]   |
| \`-\`      | Subtraction    | \`10 - 4\`  | \`6\`        |                                   |
| \`*\`      | Multiplication | \`3 * 4\`   | \`12\`       | Also repeats [[1.2_str]] and [[1.7_list]] |
| \`/\`      | Division       | \`10 / 3\`  | \`3.333...\` | **Always** returns [[1.4_float]]      |
| \`//\`     | Floor Division | \`10 // 3\` | \`3\`        | Rounds DOWN to nearest [[1.3_int]]    |
...
- **Store results:** [[3.2_Assignment]] (\`+=\`, \`-=\`, etc.)
- **Compare results:** [[3.4_Comparison]] (\`==\`, \`>\`, \`<\`)
- **Data types used:** [[1.3_int]] · [[1.4_float]] · [[1.2_str]] · [[1.7_list]]
- **Parent:** [[00_Index]]
`;export{e as default};