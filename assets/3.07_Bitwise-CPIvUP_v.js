...
- **Binary methods:** [[2.06_Int_Methods]] (\`bit_length()\`, \`bit_count()\`)
- **Related operators:** [[3.01_Arithmetic]] (math), [[3.03_Logical]] (similar concept at boolean level)
- **Compound assignment:** [[3.02_Assignment]] (\`&=\`, \`|=\`, \`^=\`, \`<<=\`, \`>>=\`)
- **Data types used:** [[1.03_Interger]] · [[1.05_Bool]]
- **Parent:** [[00_Index]]
`;export{e as default};