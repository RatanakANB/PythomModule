...
2. \`.title()\` → Capitalize first letter of each word → \`"John Smith"\` ([[2.05_String_Methods]])
3. The **dot** chains two methods: \`strip()\` runs first, then \`title()\` runs on the result
4. Original \`raw_name\` is **unchanged** — [[2.02_Mutability_vs_Immutability|immutable]]
...
- **Mutable vs Immutable behavior:** [[2.02_Mutability_vs_Immutability]]
...
- **All methods overview:** [[2.04_Methods_Insight]]
`;export{e as default};