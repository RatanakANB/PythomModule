...
Integers represent countable, exact quantities. Unlike [[1.4_float]], they have no decimal part.
...
2. \`+\` [[3.1_Arithmetic|operator]] adds them: \`3 + 2 + 4 + 1 + 5 = 15\`
3. \`/\` division **always** returns a [[1.4_float]], even if the answer is whole
...
- **Methods:** [[2.6_Int_Methods]] (11 methods)
- **Related types:** [[1.4_float]] (decimal version), [[1.5_bool]] (True=1, False=0), [[1.2_str]] (convert with \`str()\`)
- **Operators:** [[3.1_Arithmetic]] (math), [[3.4_Comparison]] (compare numbers), [[3.2_Assignment]] (update values), [[3.7_Bitwise]] (binary operations)
- **Key concept:** [[2.2_Mutability_vs_Immutability]] — integers are **immutable**
`;export{e as default};