...
> 🔧 Methods: [[2.07_Float_Methods]]

---

## 📖 Beginner-Friendly Explanation

A **float** is a **decimal number** — any number with a decimal point. Even \`3.0\` is a float, not an [[1.03_Interger]].
...
- **Methods:** [[2.07_Float_Methods]] (8 methods)
- **Related types:** [[1.03_Interger]] (whole number version), [[1.02_String]] (convert with \`str()\`), [[1.05_Bool]] (\`0.0\` is False, anything else is True)
- **Operators:** [[3.01_Arithmetic]] (math with decimals), [[3.04_Comparison]] (compare values)
- **Key concept:** [[2.02_Mutability_vs_Immutability]] — floats are **immutable**
`;export{e as default};