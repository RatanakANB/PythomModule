...
> 🏠 Parent: [[1.10_dictionary]] · [[2.1_What_Are_Methods]]
> 📂 Section: Methods
> 🔑 Key concept: Tuples are [[2.2_Mutability_vs_Immutability|immutable]] — they only have **2 methods** because you can't change them!
...
This is a great example of [[2.2_Mutability_vs_Immutability]] in action — mutable types like [[1.7_list]] have 11 methods, while an immutable [[1.10_dictionary]] only needs 2.
...
- **Compare with:** [[2.9_List_Methods]] — lists have 11 methods because they're mutable
- **Key concept:** [[2.2_Mutability_vs_Immutability]] — why tuples have so few methods
- **Call syntax:** [[2.3_Method_Call_Syntax]]
- **Shared methods:** \`index()\` and \`count()\` also exist in [[2.9_List_Methods]] and [[2.5_String_Methods]]
