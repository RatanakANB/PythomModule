...
Integers represent countable, exact quantities. Unlike [[float]], they have no decimal part.
...
2. \`+\` [[Arithmetic|operator]] adds them: \`3 + 2 + 4 + 1 + 5 = 15\`
3. \`/\` division **always** returns a [[float]], even if the answer is whole
...
- **Parent:** [[Variables]]
- **Methods:** [[Int_Methods]] (11 methods)
- **Related types:** [[float]] (decimal version), [[bool]] (True=1, False=0), [[str]] (convert with \`str()\`)
- **Operators:** [[Arithmetic]] (math), [[Comparison]] (compare numbers), [[Assignment]] (update values), [[Bitwise]] (binary operations)
- **Key concept:** [[Mutability_vs_Immutability]] — integers are **immutable**
`;export{e as default};