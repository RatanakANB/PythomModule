...
Arithmetic operators perform mathematical operations on numbers ([[int]], [[float]]).
...
| -------- | -------------- | --------- | ---------- | --------------------------------- |
| \`+\`      | Addition       | \`5 + 3\`   | \`8\`        | Also joins [[str]] and [[list]]   |
| \`-\`      | Subtraction    | \`10 - 4\`  | \`6\`        |                                   |
| \`*\`      | Multiplication | \`3 * 4\`   | \`12\`       | Also repeats [[str]] and [[list]] |
| \`/\`      | Division       | \`10 / 3\`  | \`3.333...\` | **Always** returns [[float]]      |
| \`//\`     | Floor Division | \`10 // 3\` | \`3\`        | Rounds DOWN to nearest [[int]]    |
...
- **Store results:** [[Assignment]] (\`+=\`, \`-=\`, etc.)
- **Compare results:** [[Comparison]] (\`==\`, \`>\`, \`<\`)
- **Data types used:** [[int]] · [[float]] · [[str]] · [[list]]
- **Parent:** [[00_Index]]
`;export{e as default};