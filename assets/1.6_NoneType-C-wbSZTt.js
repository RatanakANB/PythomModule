...
3. \`phone = "012-345-6789"\` → Now phone holds a [[1.2_str]] value
...
- **Related types:** [[1.5_bool]] (\`bool(None)\` → \`False\`), [[1.2_str]] (\`str(None)\` → \`"None"\`)
- **Operators:** [[3.6_Identity]] (\`is None\` is the correct way to check), [[3.3_Logical]] (None is falsy in logic)
- **Key concept:** None has **no methods** — it's the simplest type
- **Compare with:** [[1.3_int]] (0), [[1.2_str]] (""), [[1.7_list]] ([]) — these are "empty" but NOT None
`;export{e as default};