...
- [[3.4_Comparison]] — Symbols like \`>\` and \`==\`
- [[3.3_Logical]] — Using \`and\`, \`or\`, \`not\` in conditions
- [[1.5_bool]] — The result of any condition
- [[6.1_Functions_Basics]] — \`if\` statements are often used inside functions
`;export{e as default};