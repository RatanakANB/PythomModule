...
> 🏠 Parent: [[float]] · [[What_Are_Methods]]
> 📂 Section: Methods
> 🔑 Key concept: Floats are [[Mutability_vs_Immutability|immutable]] — all methods return **new** values

---

## 📖 Beginner-Friendly Explanation

Floats have **8 methods** — for converting between formats, checking properties, and working with the complex number system. They're simpler than [[String_Methods]] but important for understanding how Python handles decimal numbers.
...
- **Data type:** [[float]]
- **Similar methods:** [[Int_Methods]] · [[Bool_Methods]]
- **Call syntax:** [[Method_Call_Syntax]]
- **Related operators:** [[Arithmetic]] · [[Comparison]]
