...
> 🏠 Parent: [[set]] · [[What_Are_Methods]]
> 📂 Section: Methods
> 🔑 Key concept: Sets are [[Mutability_vs_Immutability|mutable]] — many methods **modify the set in place**
...
Add **multiple items** from another iterable ([[list]], [[tuple]], another set, etc.).
...
> Return [[bool]] — check relationships between sets.
...
- **Data type:** [[set]]
- **Mutable behavior:** [[Mutability_vs_Immutability]]
- **Call syntax:** [[Method_Call_Syntax]]
- **Compare with:** [[List_Methods]] (ordered, allows duplicates)
- **Overview:** [[Methods_Insight]]
- **Operators:** [[Membership]] (\`in\` is very fast for sets)
`;export{e as default};