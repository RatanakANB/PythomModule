...
A **tuple** is like a [[list]] that **cannot be changed** after creation. It's ordered, allows duplicates, but is **locked** — you can't add, remove, or modify items.
...
2. \`home[0]\` → Access latitude by index (still works like a [[list]])
3. \`home[0] = 12.0\` → ❌ ERROR — tuples are **immutable** (see [[Mutability_vs_Immutability]])
...
- **Parent:** [[Variables]]
- **Methods:** [[Tuple_Methods]] (only 2 methods: \`count\` and \`index\`)
- **Similar types:** [[list]] (same but mutable), [[str]] (also immutable and indexable)
- **Related types:** [[set]] (unordered version), [[dict]] (key-value pairs)
- **Operators:** [[Arithmetic]] (\`+\` joins tuples), [[Membership]] (\`in\` checks for items), [[Comparison]] (compare tuples)
- **Key concept:** [[Mutability_vs_Immutability]] — tuples are **immutable**
`;export{e as default};