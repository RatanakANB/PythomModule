...
> 🏠 Parent: [[tuple]] · [[What_Are_Methods]]
> 📂 Section: Methods
> 🔑 Key concept: Tuples are [[Mutability_vs_Immutability|immutable]] — they only have **2 methods** because you can't change them!
...
This is a great example of [[Mutability_vs_Immutability]] in action — mutable types like [[list]] have 11 methods, while an immutable [[tuple]] only needs 2.
...
3. \`100 in scores\` → [[Membership]] operator checks if \`100\` exists → \`False\`
4. You **can't** change scores — that's why we use a tuple, not a [[list]]
...
- **Data type:** [[tuple]]
- **Compare with:** [[List_Methods]] — lists have 11 methods because they're mutable
- **Key concept:** [[Mutability_vs_Immutability]] — why tuples have so few methods
- **Call syntax:** [[Method_Call_Syntax]]
- **Shared methods:** \`index()\` and \`count()\` also exist in [[List_Methods]] and [[String_Methods]]
