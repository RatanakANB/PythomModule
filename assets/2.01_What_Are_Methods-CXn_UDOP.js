...
A **method** is a **built-in tool** that belongs to a specific data type. Every [[1.02_String]], [[1.03_Interger]], [[1.07_list]], [[1.10_dictionary]], and other type comes with its own set of methods.
...
**Step-by-step:**
1. \`email.strip()\` → Removes whitespace (a [[2.05_String_Methods|string method]])
2. \`.lower()\` → Converts to lowercase — **method chaining** (calling two methods in a row)
3. \`todo.append("groceries")\` → A [[2.09_List_Methods|list method]] that adds in place
...
Each toy (variable) has its **own special buttons** (methods). A [[1.02_String|text toy]] has different buttons than a [[1.07_list|box toy]]!

---

## 🔗 Related Concepts

- **How to call methods:** [[2.03_Method_Call_Syntax]]
- **Mutable vs Immutable:** [[2.02_Mutability_vs_Immutability]]
- **All methods at a glance:** [[2.04_Methods_Insight]]
- **Method references:** [[2.05_String_Methods]] · [[2.06_Int_Methods]] · [[2.07_Float_Methods]] · [[2.08_Bool_Methods]] · [[2.09_List_Methods]] · [[2.10_Set_Methods]] · [[2.11_Tuple_Methods]] · [[2.12_Dict_Methods]]
- **Parent types:** [[1.02_String]] · [[1.03_Interger]] · [[1.04_Float]] · [[1.05_Bool]] · [[1.07_list]] · [[1.08_set]] · [[1.09_tuple]] · [[1.10_dictionary]]
`;export{e as default};