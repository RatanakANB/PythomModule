...
**Comparison operators** compare two values and return a [[1.05_Bool]] — either \`True\` or \`False\`. They answer questions like: "Are these equal?", "Is this bigger?", "Is this smaller?"
...
- **Results are:** [[1.05_Bool]] (True/False)
- **Combine comparisons:** [[3.03_Logical]] (\`and\`, \`or\`, \`not\`)
- **Check same object:** [[3.06_Identity]] (\`is\`, \`is not\`)
- **Check contains:** [[3.05_Membership]] (\`in\`, \`not in\`)
- **Math before comparing:** [[3.01_Arithmetic]]
- **Parent:** [[00_Index]]
`;export{e as default};