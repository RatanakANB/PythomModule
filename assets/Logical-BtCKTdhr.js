...
**Logical operators** combine multiple [[bool|boolean]] conditions. They answer questions like: "Are BOTH conditions true?", "Is at LEAST ONE true?", "Is this NOT true?"
...
- **Produces:** [[bool]] values (True/False)
- **Works with:** [[Comparison]] operators (combine conditions)
- **Related:** [[Identity]] (\`is\`, \`is not\`), [[Membership]] (\`in\`, \`not in\`)
- **Variables:** [[Variables]]
- **Parent:** [[00_Index]]
`;export{e as default};