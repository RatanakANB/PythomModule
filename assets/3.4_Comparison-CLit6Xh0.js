...
**Comparison operators** compare two values and return a [[1.5_bool]] — either \`True\` or \`False\`. They answer questions like: "Are these equal?", "Is this bigger?", "Is this smaller?"
...
- **Results are:** [[1.5_bool]] (True/False)
- **Combine comparisons:** [[3.3_Logical]] (\`and\`, \`or\`, \`not\`)
- **Check same object:** [[3.6_Identity]] (\`is\`, \`is not\`)
- **Check contains:** [[3.5_Membership]] (\`in\`, \`not in\`)
- **Math before comparing:** [[3.1_Arithmetic]]
- **Parent:** [[00_Index]]
`;export{e as default};