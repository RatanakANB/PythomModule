...
**Assignment operators** store values in [[Variables|variables]]. The basic \`=\` assigns a value. The shorthand operators like \`+=\` combine an [[Arithmetic|arithmetic]] operation with assignment in one step.
...
- **Math operations:** [[Arithmetic]] (the operations behind \`+=\`, \`-=\`, etc.)
- **Compare values:** [[Comparison]]
- **Variables:** [[Variables]]
- **Also used with:** [[Bitwise]] (\`&=\`, \`|=\`, \`^=\`, \`<<=\`, \`>>=\`)
- **Parent:** [[00_Index]]
`;export{e as default};