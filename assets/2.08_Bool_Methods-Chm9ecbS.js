...
> 🏠 Parent: [[1.05_Bool]] · [[2.01_What_Are_Methods]]
> 📂 Section: Methods
> 🔑 Key concept: \`bool\` **inherits** from [[1.03_Interger]], so it shares all [[2.06_Int_Methods]]

---

## 📖 Beginner-Friendly Explanation

Booleans (\`True\` and \`False\`) are secretly a **subclass of integers** in Python. \`True\` is \`1\` and \`False\` is \`0\`. Because of this, booleans **inherit all 11 methods from [[1.03_Interger]]**.

You can call any [[2.06_Int_Methods]] on a boolean — though in practice, you rarely need to.
...
- **Data type:** [[1.05_Bool]]
- **Inherits from:** [[1.03_Interger]] → [[2.06_Int_Methods]]
- **Used by:** [[3.04_Comparison]] operators (return bools), [[3.03_Logical]] operators (\`and\`, \`or\`, \`not\`)
