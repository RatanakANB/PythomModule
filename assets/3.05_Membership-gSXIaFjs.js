...
Python has 2 membership operators: \`in\` and \`not in\`. They check whether a value is found inside a sequence ([[1.02_String]], [[1.07_list]], [[1.09_tuple]], [[1.08_set]], [[1.10_dictionary]]).
...
- **Works with:** [[1.02_String]] · [[1.07_list]] · [[1.09_tuple]] · [[1.08_set]] · [[1.10_dictionary]]
- **Results are:** [[1.05_Bool]]
- **Combine with:** [[3.03_Logical]] (\`and\`, \`or\`, \`not\`)
- **Related:** [[3.04_Comparison]] (compares values), [[3.06_Identity]] (checks same object)
- **Set is fastest:** [[1.08_set]] is designed for membership testing
- **Dict checks keys:** [[1.10_dictionary]] — \`in\` only checks keys, not values
- **Parent:** [[00_Index]]
