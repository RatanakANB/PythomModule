...
3. \`.append("Music")\` → [[2.9_List_Methods|List method]] that adds to the end
4. \`.remove("Art")\` → Finds and removes \`"Art"\`
5. \`.sort()\` → Sorts the list in place — changes the original! (see [[2.2_Mutability_vs_Immutability]])
